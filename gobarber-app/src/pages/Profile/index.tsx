...
import { View, ScrollView, KeyboardAvoidingView, Platform, TextInput, Alert, Button as ButtonRN } from 'react-native'
	...
	const handleSingUp = useCallback(
		async (data: ProfileFormData) => {
			try {
				...
				Alert.alert('Erro na atualização do perfil', 'Ocorreu um atualizar o seu perfil, tente novamente.')
			}
		},
			...
			<KeyboardAvoidingView style={{flex: 1}} behavior={Platform.OS === 'ios' ? 'padding': undefined} enabled>
				<ScrollView contentContainerStyle={{flex: 1}} keyboardShouldPersistTaps='handled'>
					<Container>
						...
						<UserAvatarButton onPress={updatePhotoFromGallery}>
